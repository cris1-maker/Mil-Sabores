...
export default function Carrito() {
  ...
  const handleCheckout = () => {
    if (carrito.length > 0) {
      navigate("/checkout"); // ⬅️ Te lleva al formulario de compra
    }
  };
  ...
  return (
    <>
                  ...
                  <tr key={producto.id}>
                    ...
                    <td>
                      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <span style={{ margin: '0 15px', fontSize: '1.2em' }}>{producto.cantidad}</span>
                        <button
      ...
      {/* Botones inferiores */}
      <div className="center-align" style={{ marginBottom: "40px", marginTop: "20px" }}>
        <button
